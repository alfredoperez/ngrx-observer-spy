      ...
      providers: [
        ElementsLoader,
        {
          ...
          >([
            [
              'element-a-selector',
              () => Promise.resolve(new FakeModuleFactory('element-a-module')),
            ],
            [
              'element-b-selector',
              () => Promise.resolve(new FakeModuleFactory('element-b-module')),
            ],
            [
              'element-c-selector',
              () => Promise.resolve(FakeCustomElementModule),
            ],
          ]),
        },
      ],
  ...
  describe('loadCustomElement()', () => {
    ...
    it('should be able to load and register an element after compiling its NgModule', fakeAsync(() => {
      const compilerSpy = spyOn(compiler, 'compileModuleAsync').and.returnValue(
        Promise.resolve(new FakeModuleFactory('element-c-module'))
      );
