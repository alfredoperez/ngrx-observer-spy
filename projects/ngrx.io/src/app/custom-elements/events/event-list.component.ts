  ...
  template: `
    ...
    <table class="is-full-width">
      ...
      <tbody>
        <tr
          *ngFor="
            let upcomingEvent of upcomingEvents$
              | async
              | eventOrderBy: 'ascending'
          "
        >
          <th>
            <a [href]="upcomingEvent.url" [title]="upcomingEvent.name">{{
              upcomingEvent.name
            }}</a>
          </th>
    ...
    <table class="is-full-width">
      ...
      <tbody>
        <tr
          *ngFor="
            let pastEvent of pastEvents$ | async | eventOrderBy: 'descending'
          "
        >
          <th>
            <a [href]="pastEvent.url" [title]="pastEvent.name">{{
              pastEvent.name
            }}</a>
          </th>
