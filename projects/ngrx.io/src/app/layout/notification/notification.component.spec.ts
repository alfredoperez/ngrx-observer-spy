...
describe('NotificationComponent', () => {
  ...
  it('should update localStorage key when dismiss is called', () => {
    configTestingModule();
    createComponent();
    const setItemSpy: jasmine.Spy = TestBed.inject<Window>(WindowToken)
  ...
  it('should not show the notification if the there is a "hide" flag in localStorage', () => {
    configTestingModule();
    const getItemSpy: jasmine.Spy = TestBed.inject<MockWindow>(WindowToken)
