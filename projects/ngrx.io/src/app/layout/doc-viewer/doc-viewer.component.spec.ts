...
describe('DocViewerComponent', () => {
  ...
  describe('#doc', () => {
    ...
    beforeEach(
      () =>
        (renderSpy = spyOn(docViewer, 'render').and.callFake(() =>
          of(undefined)
        ))
    );
  ...
  describe('#ngOnDestroy()', () => {
    it('should stop responding to document changes', () => {
      const renderSpy = spyOn(docViewer, 'render').and.callFake(() =>
        of(undefined)
      );
  ...
  describe('#render()', () => {
    ...
    beforeEach(() => {
      ...
      swapViewsSpy = spyOn(docViewer, 'swapViews').and.callFake(() =>
        of(undefined)
      );
    });
  ...
  describe('#swapViews()', () => {
    ...
    const doSwapViews = (cb?: () => void) =>
      docViewer.swapViews(cb).toPromise();
